...
{
    public class UICraftRequiredItem : UIBase
    {
        #region ¹ÙÀÎµù
        enum Images
        {
        ...
        internal void Show(RequiredItem requiredItem)
        {
            var variable = SaveManager.Instance.profileData.GetVariable(requiredItem.Variable);
