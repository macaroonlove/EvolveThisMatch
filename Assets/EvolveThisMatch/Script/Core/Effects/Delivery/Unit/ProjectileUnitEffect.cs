...
{
    public class ProjectileUnitEffect : UnitEffect
    {
        ...
        public override void Deliver(EffectContext effectContext, Unit casterUnit, Unit targetUnit)
        {
            ...
            casterUnit.GetAbility<EntitySpawnAbility>().SpawnProjectile(_prefab, _spawnPoint, targetUnit, (caster, target) => { Resolve(effectContext, caster, target); });
        }
